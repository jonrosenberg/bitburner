const metadata = {
  ...
  [AugmentationName.CongruityImplant]: {
    ...
    stats:
      "This Augmentation removes the Entropy virus, and prevents it from affecting you again.",
    factions: []
  },
  ...
  [AugmentationName.INFRARet]: {
    ...
    moneyCost: 3e7,
    info:
      "A tiny chip that sits behind the retina. This implant lets the user visually detect infrared radiation.",
    crime_success: 1.25,
    crime_money: 1.1,
    dexterity: 1.1,
  ...
  [AugmentationName.Targeting3]: {
    ...
    repCost: 2.75e4,
    info:
      "The latest version of the 'Augmented Targeting' implant adds the ability to lock-on and track threats.",
